...
1. Clone the repository:
   ```bash
   git clone https://github.com/VarshithGaddam/Voice-Based-Cognitive-Decline-Pattern-Detection.git
...
## Usage
1. Place audio files (e.g., `.wav` from DementiaBank Pitt Corpus) in the `data/raw_samples/` directory.
2. Run the pipeline:
   ```bash
   python main.py
   ```
